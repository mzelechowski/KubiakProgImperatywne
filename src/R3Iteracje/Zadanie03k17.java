...
public class Zadanie03k17 {
    public static void main(String[] args) {
        /*napisz program, który  za pomocą instrukcji do-while() znajduje największą i najmniejszą liczbę
        ze zbioru n wylosowanych liczb całkowitych od 0 do 99 (w zadaniu n=5) oraz oblicza średnią ze
        wszystkich wylosowanych liczb
         */
        int min=99, max=0, n = 5, random, average=0, i=0;
        int[] tab=new int[5];
        do {
